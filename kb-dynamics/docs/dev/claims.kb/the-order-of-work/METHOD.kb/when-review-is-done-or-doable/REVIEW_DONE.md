...
why:
  - ../paid-out-means-one-target-ledger-is-trusted-again/PAYOUT_TEST.md
  - ../../../what-no-move-may-raise/DEBT.kb/owner-review-is-a-queue-sorted-by-debt/QUEUE.md
...
`QUEUE_EMPTY_TRUST`. "Fits one sitting" is a field quantity the sandbox
does not compute.
