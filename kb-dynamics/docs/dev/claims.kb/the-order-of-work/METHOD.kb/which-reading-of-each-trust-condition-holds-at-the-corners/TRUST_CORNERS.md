...
why:
  - ../when-review-is-done-or-doable/REVIEW_DONE.md
...
and the owner rejected the premise; `REVIEW_DONE` and `EFFECTIVE_BASIS`
...
What the corners in `examples/corners/` witness, restated: `REVIEW_DONE`'s
...
`QUEUE_EMPTY_TRUST` states exactly. "Fits one sitting" is a field
