...
why:
  - ../../../what-the-harness-shows/HARNESS.kb/the-agent-is-replaced-by-a-generator-not-modeled/GENERATOR_NOT_AGENT.md
---
...
and as the deferrals in `../../../weighing-a-candidate-rule/RULE_PRICING.md`; its ordering does not.
