...
authority:
  address: dfc18e9d
  words: the fact that the reduction for this component is CONFLICT_REDUCTIONS makes me think its old name is no longer good. "CONFLICT" seems more appropriate?
...
set (`CONFLICT_ARITY`), that says they cannot all stand. The common
...
member. Reduced by `CONFLICT_REDUCTIONS`.
