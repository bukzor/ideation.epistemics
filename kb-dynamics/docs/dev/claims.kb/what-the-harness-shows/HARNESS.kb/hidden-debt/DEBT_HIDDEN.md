...
why:
  - ../the-properties/PROPERTY_SET.md
  - ../../../what-no-move-may-raise/DEBT.kb/what-voids-repayment/UNREPAYABLE.md
  - ../../../what-no-move-may-raise/DEBT.kb/no-agent-move-raises-debt-silently/NO_SILENT_RAISE.md
  - ../../../states-and-moves/MODEL.kb/the-move-table-is-total-and-an-empty-cell-is-a-finding/MOVE_TABLE.md
  - ../../../what-no-move-may-raise/DEBT.kb/basis-and-record-guard-agent-pruning/PRUNE_GUARD.md
---
...
gone. That is a loss the components do not count and `COMPONENTS_CLOSURE` should
