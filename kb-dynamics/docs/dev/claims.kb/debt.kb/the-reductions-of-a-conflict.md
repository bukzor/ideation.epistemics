...
why:
  - components.kb/a-set-of-claims-that-cannot-all-stand.md
  - every-agent-authority-move-is-queued-for-veto.md
  - ../model.kb/a-move-is-tagged-by-the-authority-it-carries-not-the-hands.md
---
